...
<!--         // <script type="text/javascript" src="./lib/sets/experimental/experimental.js"></script>
    ...
    <body onload="init('<?= isset($_REQUEST['diagramId']) ? $_REQUEST['diagramId']:''?>');" id="body">
        ...
        <div id="actions">
            ...
            <a href="javascript:action('run');"  title="Compile and Run"><img src="assets/images/run.png" border="0"/></a>
            <img class="separator" src="assets/images/toolbar_separator.gif" border="0" width="1" height="16"/>
        ...
        <div id="editor">
            ...
            <div>
                <div  id="container">
                    <canvas id="a" width="780" height="600">
            ...
            <!-- <div id="right" style="float: right;">
                ...
                <form>
                    <textarea class="lined" id="code" name="code" onblur="" placeholder="Your code goes here"></textarea> 
                    <input class="fullwidth" onclick="PostData();" type="button" value="Compile and Run" />
                    <p id="waiting"></p>
                    <textarea id="results" name="results" onblur="" placeholder="Your output will be displayed here"></textarea>
                </form>
                </center>
            </div> -->
            ...
            <div id="right" style="float: right;">
                <center>
                    <h3>Code and Output</h3>
                <form>
                    <textarea class="lined" id="code" name="code" onblur="" style="overflow: auto;" cols="50" rows="15" placeholder="Your code goes here"></textarea> <br>
                    <!-- <input class="fullwidth" onclick="PostData();" type="button" value="Compile and Run" /> -->
                    <!-- <p id="waiting"></p> -->
                    <textarea id="results" name="results" onblur=""  style="overflow: auto;" cols="50" rows="10" placeholder="Your output will be displayed here"></textarea>
                </form>
                <div style="overflow: auto;" id="edit"></div>
                </center>
                <div id="minimap"></div>
            </div>
